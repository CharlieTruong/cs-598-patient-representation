...
if __name__ == "__main__":
  ...
  optimizer = tf.keras.optimizers.RMSprop(lr=cfg.getfloat('dan', 'learnrt'))
  model.compile(loss='binary_crossentropy', optimizer=optimizer, metrics=['accuracy'])
  model.fit(train_x, train_y, epochs=cfg.getint('dan', 'epochs'), batch_size=cfg.getint('dan', 'batch'), validation_split=0.0)
  ...
  int2code = {value: key for key, value in dataset.code2int.items()}
